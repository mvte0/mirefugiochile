# Códigos de error para Transaction.refund() de Transbank
# Referencia: Documentación de Webpay

REFUND_ERROR_CODES = {
    304: "Validación de campos de entrada nulos",
    245: "Código de comercio no existe",
    22: "El comercio no se encuentra activo",
    316: "El comercio indicado no corresponde al certificado o no es hijo del comercio MALL",
